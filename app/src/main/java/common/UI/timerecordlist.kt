        ...
        if (times.isNotEmpty()) {
            Card(elevation = 5.dp, modifier = Modifier.fillMaxWidth().padding(10.dp)) {
                Row(modifier = Modifier.padding(10.dp)) {
                    Text(stringResource(R.string.task), Modifier.weight(1f))
                    Text(stringResource(R.string.Date), Modifier.weight(2f))
                    Text(
                        stringResource(R.string.Duration), Modifier.weight(1f)
                    )
                }
            }
        }
            ...
            Card(elevation = 5.dp, modifier = Modifier.fillMaxWidth().padding(10.dp,10.dp)) {
                Row(modifier = Modifier.padding(10.dp)) {
                    ...
                    duration.toComponents { days, hours, minutes, seconds, nanoseconds ->
                        Text(" ${hours}h:${minutes}m:${seconds}s", Modifier.weight(1f)
                        )
                    }
                }
            }
