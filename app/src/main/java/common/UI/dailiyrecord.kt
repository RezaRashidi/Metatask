    ...
    LazyColumn(modifier = Modifier.background(MaterialTheme.colors.background)) {
        ...
        item {
            Row(Modifier.fillMaxWidth().padding(10.dp), horizontalArrangement = Arrangement.Center) {
                Text(stringResource(R.string.DailyRecord), style = MaterialTheme.typography.h6)
            }
        ...
        item {
            Card(Modifier.fillMaxWidth().padding(8.dp), elevation = 5.dp) {
                Row(Modifier.fillMaxWidth().padding(10.dp), horizontalArrangement = Arrangement.SpaceBetween) {
                    Text(stringResource(R.string.Date), Modifier.weight(2f))
                    Text(stringResource(R.string.Time), Modifier.weight(2f))
